...
const BookShow = () => {
  ...
  const getSeats = () => {
    ...
    let rows = Math.ceil(totalSeats / columns); // Calculating number of rows - 10
        ...
        >
          {Array.from(Array(rows).keys()).map((row) =>
            ...
            Array.from(Array(columns).keys()).map((column) => {
              ...
              // for row 9 and col 11 => 9*12 + 11 + 1 = 108 + 11 + 1 = 120
              // row 1 and col 2 => 1*12 + 2 + 1 = 12 + 2 + 1 = 15
            ...
            >
              ...
              {selectedSeats.length > 0 && (
                <StripeCheckout
                  ...
                  stripeKey="pk_test_51Pzb6VEplu3GkvQxb1f5FtNQLmxV2XzqQu1xj6mm6xogP41XQNzB8Kk7Tid8EjA4WbFHBlEb1awIkJugXHhMb9pE00GAZ5HYCO"
                >
